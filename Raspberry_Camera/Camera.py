""" Author: Arto Manuel, Gabriele Genovese, Federico Crescentini
    ...
    This is the program running on the Raspberry with the camera module installed.
    It create a webserver that serve a recording of the camera at 24 frame per second
"""
import io
import picamera
...
# Custom output for "start_recording(custom, format="")"
